...
/**
 * @type reduxActions.Action<TableOptions>
 */
const setCurrentTableOptions = reduxActions.createAction(
  ActionType.SetCurrentTableOptions
)

export default setCurrentTableOptions
